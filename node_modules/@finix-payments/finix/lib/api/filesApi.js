...
class FilesApi {
     ...
     */
    downloadHelper(fileId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param fileId The ID of the &#x60;File&#x60; that was created to upload the file.
     */
    download(fileId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const responseObject = yield this.downloadHelper(fileId, options);
            return responseObject.body;
        });
    }
    /**
     ...
     * @param fileId The ID of the &#x60;File&#x60; that was created to upload the file.
     */
    downloadHttp(fileId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const responseObject = yield this.downloadHelper(fileId, options);
            return responseObject;
        });
    ...
    */
     ...
     */
    uploadHelper(fileId, uploadFileRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param uploadFileRequest
     */
    upload(fileId, uploadFileRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const responseObject = yield this.uploadHelper(fileId, uploadFileRequest, options);
            return responseObject.body;
        });
    }
    /**
     ...
     * @param uploadFileRequest
     */
    uploadHttp(fileId, uploadFileRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const responseObject = yield this.uploadHelper(fileId, uploadFileRequest, options);
            return responseObject;
        });

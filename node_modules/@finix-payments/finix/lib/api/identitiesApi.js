...
class IdentitiesApi {
     ...
     */
    createAssociatedIdentityHelper(identityId, createAssociatedIdentityRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (createAssociatedIdentityRequest && createAssociatedIdentityRequest.hasOwnProperty('file')) {
                ...
                localVarRequestOptions.body = models_1.ObjectSerializer.serialize(createAssociatedIdentityRequest, "CreateAssociatedIdentityRequest");
            }
     ...
     * @param createAssociatedIdentityRequest
     */
    createAssociatedIdentity(identityId, createAssociatedIdentityRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const responseObject = yield this.createAssociatedIdentityHelper(identityId, createAssociatedIdentityRequest, options);
     ...
     * @param createAssociatedIdentityRequest
     */
    createAssociatedIdentityHttp(identityId, createAssociatedIdentityRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const responseObject = yield this.createAssociatedIdentityHelper(identityId, createAssociatedIdentityRequest, options);
    ...
    *
    */
    listAssociatedIdentitiesHelper(identityId, listIdentityAssociatedIdentitiesQueryParams, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/identities/{identity_id}/associated_identities'
                .replace('{' + 'identity_id' + '}', encodeURIComponent(String(identityId)));
            let localVarQueryParameters = {};
     ...
     *
     */
    listAssociatedIdentities(identityId, listIdentityAssociatedIdentitiesQueryParams, options = { headers: {} }) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const responseObject = yield this.listAssociatedIdentitiesHelper(identityId, listIdentityAssociatedIdentitiesQueryParams, options);
            // Check if response body has nextCursor property or offset property and extract the corresponding fields
            let reachedEnd;
            const hasNextCursor = (_b = (_a = responseObject.body) === null || _a === void 0 ? void 0 : _a.page) === null || _b === void 0 ? void 0 : _b.hasOwnProperty('nextCursor');
            let queryParam = hasNextCursor ? { afterCursor: '', limit: 20 } : { offset: '', limit: 20 };
     ...
     *
     */
    listAssociatedIdentitiesHttp(identityId, listIdentityAssociatedIdentitiesQueryParams, options = { headers: {} }) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const responseObject = yield this.listAssociatedIdentitiesHelper(identityId, listIdentityAssociatedIdentitiesQueryParams, options);
            // Check if response body has nextCursor property or offset property and extract the corresponding fields

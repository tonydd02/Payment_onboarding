...
__exportStar(require("./complianceFormsApi"), exports);
const complianceFormsApi_1 = require("./complianceFormsApi");
...
__exportStar(require("./onboardingFormsApi"), exports);
const onboardingFormsApi_1 = require("./onboardingFormsApi");
__exportStar(require("./paymentInstrumentsApi"), exports);
const paymentInstrumentsApi_1 = require("./paymentInstrumentsApi");
__exportStar(require("./payoutProfilesApi"), exports);
const payoutProfilesApi_1 = require("./payoutProfilesApi");
...
class HttpError extends Error {
    constructor(response, rawBody, statusCode) {
...
exports.APIS = [authorizationsApi_1.AuthorizationsApi, balanceTransfersApi_1.BalanceTransfersApi, complianceFormsApi_1.ComplianceFormsApi, devicesApi_1.DevicesApi, disputesApi_1.DisputesApi, feeProfilesApi_1.FeeProfilesApi, filesApi_1.FilesApi, identitiesApi_1.IdentitiesApi, instrumentUpdatesApi_1.InstrumentUpdatesApi, merchantProfilesApi_1.MerchantProfilesApi, merchantsApi_1.MerchantsApi, onboardingFormsApi_1.OnboardingFormsApi, paymentInstrumentsApi_1.PaymentInstrumentsApi, payoutProfilesApi_1.PayoutProfilesApi, settlementsApi_1.SettlementsApi, transfersApi_1.TransfersApi, verificationsApi_1.VerificationsApi, webhooksApi_1.WebhooksApi];

...
describe('Transfers API', () => {
    ...
    test("Test: Debit a bank account (ie eCheck)", () => __awaiter(void 0, void 0, void 0, function* () {
        const debitRequest = {
            fee: 603,
        ...
        const debitAccountTransfer = yield client.Transfers.create(debitRequest);
    ...
    test("Test: Create sale", () => __awaiter(void 0, void 0, void 0, function* () {
        const saleRequest = {
            currency: api_1.Models.Currency.Usd,
            merchant: "MUeDVrf2ahuKc9Eg5TeZugvs",
            tags: {
        ...
        const createdSaleTransfer = yield client.Transfers.create(saleRequest);
    ...
    test("Test: Create sale with 3D secure", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const created3dSecureSaleTransfer = yield client.Transfers.create(sale3dSecureRequest);
    ...
    test("Test: Create sale with level 2 processing", () => __awaiter(void 0, void 0, void 0, function* () {
        const saleL2Request = {
            currency: api_1.Models.Currency.Usd,
            merchant: "MUeDVrf2ahuKc9Eg5TeZugvs",
            tags: {
        ...
        const createdL2SaleTransfer = yield client.Transfers.create(saleL2Request);
    ...
    test("Test: Create sale with level 23 processing", () => __awaiter(void 0, void 0, void 0, function* () {
        const saleL3Request = {
            currency: api_1.Models.Currency.Usd,
            merchant: "MUeDVrf2ahuKc9Eg5TeZugvs",
            tags: {
        ...
        const createdL3SaleTransfer = yield client.Transfers.create(saleL3Request);
    ...
    test("Test: Fetch a transfer", () => __awaiter(void 0, void 0, void 0, function* () {
        const transferId = "TRnH7FkSB7zePeHExNZwSb9H";
        const fetchedTransfer = yield client.Transfers.get(transferId);
    ...
    test("Test: Fetch a transfer with http response", () => __awaiter(void 0, void 0, void 0, function* () {
        const transferId = "TRnH7FkSB7zePeHExNZwSb9H";
        const fetchedTransfer = yield client.Transfers.getHttp(transferId);
        expect(fetchedTransfer.response).toEqual(expect.any(http_1.IncomingMessage));
    ...
    test("Test: Refund a debit", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reversedTransfer = yield client.Transfers.createTransferReversal(transferId, reversalRequest);
    ...
    test("Test: Update a transfer", () => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        ...
        const updatedTransfer = yield client.Transfers.update(transferId, updateReqest);
        //expect(reversedTransfer.id).toBe(transferId);
        expect((_a = updatedTransfer.tags) === null || _a === void 0 ? void 0 : _a["order_number"]).toBe((_b = updateReqest.tags) === null || _b === void 0 ? void 0 : _b["order_number"]);
    }));
    test("Test: List all transfers", () => __awaiter(void 0, void 0, void 0, function* () {
        const transferList = yield client.Transfers.list();
    ...
    test("Test: List transfer reversals", () => __awaiter(void 0, void 0, void 0, function* () {
        const transferId = "TRvtThmhZtk56z6dtCt8hUDR";
        const transferReversalsList = yield client.Transfers.listTransfersReversals(transferId);
        ...
        if (transferReversalsList.hasMore) {
            const nextTransferList = yield transferReversalsList.listNext();
            expect(nextTransferList.page.limit).toEqual(expect.any(Number));
            expect(nextTransferList.size).toEqual(expect.any(Number));
        }
    }), 20000);
    test("Test: List transfers with query parameters", () => __awaiter(void 0, void 0, void 0, function* () {
        const transferListWithLimit = yield client.Transfers.list({
            limit: 2
        });
        expect(transferListWithLimit.page.limit).toBe(2);
        const transferListWithFilter = yield client.Transfers.list({
            amountLt: 100,
            type: "Debits"
        });
        ...
        if (transferListWithFilter.hasMore) {
            const nextTransferList = yield transferListWithFilter.listNext();
            expect(nextTransferList.page.limit).toEqual(expect.any(Number));
            expect(nextTransferList.size).toEqual(expect.any(Number));
        }
    }), 20000);
    test("Test: deserialize function test -- transfer list", () => __awaiter(void 0, void 0, void 0, function* () {
        const httpMessage = yield client.Transfers.listHttp();
        const transferListRaw = httpMessage.rawBody;
        const deserializedList = api_1.Models.ObjectSerializer.deserialize(transferListRaw, "TransfersList");
    ...
    test("Test: deserialize function and unexpected enum test -- transfer", () => __awaiter(void 0, void 0, void 0, function* () {
        const httpMessage = yield client.Transfers.getHttp("TRnH7FkSB7zePeHExNZwSb9H");
        const transferRaw = httpMessage.rawBody;
        transferRaw["state"] = "RANDOM_STATE";
        const deserializedTransfer = api_1.Models.ObjectSerializer.deserialize(transferRaw, "Transfer");

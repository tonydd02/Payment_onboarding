...
describe('Payment Instruments API', () => {
    ...
    test('Test: Create a payment card', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        paymentCardId = createdPaymentInstrument.id;
    ...
    test('Test: Create a bank account', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const createdPaymentInstrument = yield client.PaymentInstruments.create(paymentRequest);
        bankAccountId = createdPaymentInstrument.id;
        expect(createdPaymentInstrument.application).toBe("APgPDQrLD52TYvqazjHJJchM");
    ...
    // });
    test('Test: Fetch a bank account', () => __awaiter(void 0, void 0, void 0, function* () {
        const fetchedPaymentInstrument = yield client.PaymentInstruments.get(bankAccountId);
    ...
    test('Test: Update a payment instrument', () => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        ...
        const updatedPaymentInstrument = yield client.PaymentInstruments.update(bankAccountId, paymentInstrumentUpdateRequest);
        expect(updatedPaymentInstrument.id).toBe(bankAccountId);
        expect((_a = updatedPaymentInstrument.tags) === null || _a === void 0 ? void 0 : _a.Test).toBe((_b = paymentInstrumentUpdateRequest.tags) === null || _b === void 0 ? void 0 : _b.Test);
    }));
    test('Test: Fetch a payment card', () => __awaiter(void 0, void 0, void 0, function* () {
        const fetchedPaymentInstrument = yield client.PaymentInstruments.get(paymentCardId);
        expect(fetchedPaymentInstrument.id).toBe(paymentCardId);
        expect(fetchedPaymentInstrument.expirationMonth).toBe(12);
        expect(fetchedPaymentInstrument.application).toBe("APgPDQrLD52TYvqazjHJJchM");
    }));
    test("Test: List all payment instruments", () => __awaiter(void 0, void 0, void 0, function* () {
        const paymentInstrumentList = yield client.PaymentInstruments.list();
        ...
        if (paymentInstrumentList.hasMore) {
            const nextPaymentInstrumentList = yield paymentInstrumentList.listNext();
    ...
    test('Test: Unknown enum', () => __awaiter(void 0, void 0, void 0, function* () {
        const fetchedPaymentInstrument = yield client.PaymentInstruments.get("PI4gTM3twQ5XyXfM4rTuFvpo");
        expect(fetchedPaymentInstrument.type).toEqual("APPLE_PAY");
    }));
});
//# sourceMappingURL=paymentInstruments.test.js.map